...
- As a shopper, I want to browse available products so that I can choose items to purchase.
- As a developer, I want to expose a product catalog API so that the frontend can display product information.

## Epic 2: Shopping Cart Management
- As a shopper, I want to add products to a cart so that I can collect items before checkout.
- As a shopper, I want to update quantities and view the cart total so that I can control my order.
